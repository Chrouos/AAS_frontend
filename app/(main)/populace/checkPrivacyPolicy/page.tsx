...
const CheckPrivacyPolicy = () => {
    ...
    const [responsePrivacyPolicy, setResponsePrivacyPolicy] = useState<string | null>('本公司會對個別連線者的瀏覽器予以標示，歸納使用者瀏覽器在本網站內部所瀏覽的網頁，除非您願意告知或提供你的個人資料，否則本公司不會，也無法將此項記錄和您對應。請您注意，與本網站連結的其他網站，也可能蒐集您個人的資料。對於您於前述連結網站主動提供的個人資料，將依相關法令及各該連結網站所揭露之隱私權保護政策蒐集、利用與處理，不適用本網站之隱私權保護政策，本公司也不負擔任何連帶責任。\n本網站上述蒐集資料之運用政策\n線上申請及網路市場調查\n本公司於本網站所蒐集的申請或受訪者姓名、身分證字號、電話、e-mail、住址及其他個人資料，除依法令規定或經您書面同意外，僅於本公司蒐集之特定目的(包含申辦本公司金融商品、參加本網站抽獎活動或市場調查分析)必要範圍內處理及利用，本公司不會將前述個人資料用做其他用途。本公司並將依法令規範對前述個人資料負保密之責，絕不會公布個別申請者或受訪者之任何個人資訊。\n個人資料之查詢、閱覽及刪除\n對於本公司透過本網站所蒐集與保存您的個人資料，除法令另有規定外，您可以向本公司：（1）查詢或請求閱覽您的個人資料。（2）請求製給您個人資料之複製本。（3）請求補充或更正您的個人資料。\n（4）請求停止蒐集、利用或處理您的個人資料；或（5）請求刪除您的個人資料。\n您得隨時向本公司提出上述申請，本公司將依個人資料保護法及法令遵循或內部控制等相關法令規範，據以決定或受理您的申請。若您的個人資料已逾法令規定之保存時限且蒐集之特定目的均已消滅，則本公司將主動銷毀或刪除您的個人資料。\n其他\n當您在本網站主動註冊成為會員後，其所輸入的資料，僅供本網站依服務或活動設計參考使用。凡未經您主動註冊所產生的資料，例如使用者連線設備的IP位址、設備資訊、使用時間、使用的瀏覽器、瀏覽及點選紀錄等資料，本公司僅會在對本網站全體使用者整體行為進行統計分析之特定目的必要範圍內利用及處理，並不會對個別使用者進行分析。\nCookies的運用與政策\nCookies 是伺服端為了區別使用者的不同喜好，經由瀏覽器寫入使用者硬碟的一些簡短資訊。您可以在Firefox瀏覽器的「工具選項」的「個人隱私」項目或是IE瀏覽器的「網際網際網路選項」的「隱私權」項目中選擇修改您瀏覽器對Cookies的接受程度。如果您選擇「拒絕所有的cookies」，您就可能無法使用部份個人化服務，或是參與部份的活動。\n依據以下目的及情況，本公司暨所屬各子公司之相關網站會在本政策原則下，在您瀏覽器中寫入並讀取Cookies：為提供更好、更個人化的服務，以及方便您參與個人化的互動活動。');
